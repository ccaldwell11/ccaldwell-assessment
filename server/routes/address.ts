        ...
        if (features.length > 0) {
          return res.json(
            features.map((feature: any) => ({
              ...
              coordinates: feature.geometry?.x && feature.geometry?.y ? [feature.geometry.x, feature.geometry.y] : null,
            }))
          );
        }
  
        // suggestions if direct result not found
        return axios.get('https://gis.nola.gov/arcgis/rest/services/dev/property3/MapServer/14/query', {
          params: {
